...
export default function About() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="section-dark pt-32 md:pt-40 section-padding">
        <div className="content-max">
          <AnimatedSection>
            <p className="mono-label text-muted-foreground mb-4">ABOUT PLINTH</p>
            <h1 className="display-heading text-foreground mb-6" style={{ fontSize: "clamp(40px, 7vw, 96px)" }}>
              A regional builder.<br />By design.
            </h1>
            <p className="reading-column text-muted-foreground text-lg">
              Plinth designs and delivers accessory homes for the Northeast US. We offer three models, refined over time with our manufacturer, priced honestly, and built to order.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <AnimatedSection className="section-dark section-padding">
        <div className="content-max">
          <p className="mono-label text-muted-foreground mb-10">FOUNDER</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start">
            ...
            <div className="reading-column">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                We build three models. We know exactly what they cost. We work with one manufacturer we trust. And we focus on the markets we know — the Northeast, where the zoning is complex, the winters are real, and the demand for housing on existing lots is enormous.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              <p className="mono-label text-muted-foreground mt-1">FOUNDER, PLINTH</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection className="section-dark section-padding">
        <div className="content-max">
          <p className="mono-label text-muted-foreground mb-4">WHERE WE WORK</p>
